...
bin/champsim: $(patsubst %.cc,%.o,$(wildcard src/*.cc)) obj/repl_rreplacementDlru.a obj/pref_pprefetcherDno.a obj/pref_pprefetcherDno_instr.a obj/pref_pprefetcherDstream_plus_stride_prefetcher.a obj/bpred_bbranchDbimodal.a obj/btb_bbtbDbasic_btb.a
